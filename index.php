...
<head>
    ...
    <style>
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb { background: rgba(49, 227, 104, 0.3); border-radius: 10px; }

        /* Magia CSS para DataTables (Paginación con Texto) */
        .dataTables_filter, .dataTables_length { display: none !important; }
        .dataTables_info { color: #bcc9c5 !important; font-size: 0.875rem !important; padding-top: 0 !important; }
        ...
        .dataTables_paginate .paginate_button {
            ...
            padding: 0.4rem 1rem !important; /* Espacio a los lados para que quepan las palabras */
        ...
        /* El número de la página actual pintado del verde principal */
        ...
        /* Botones deshabilitados (ej. "Anterior" en la página 1) */
...
<body class="text-on-surface font-body min-h-screen relative overflow-x-hidden selection:bg-primary/30">
    ...
    <main class="relative z-10 pt-20 pb-20 px-4 md:px-12 max-w-7xl mx-auto">
        ...
        <div class="mb-12 space-y-8">
            <div class="space-y-2">
                <span class="text-primary text-md font-bold tracking-[0.2em] uppercase">ISTU</span>
            ...
            <div class="relative group w-full">
                ...
                <input id="buscadorCustom" class="w-full bg-[#041021]/80 backdrop-blur-md border border-primary/30 focus:border-primary focus:ring-2 focus:ring-primary/40 rounded-2xl transition-all duration-300 py-5 pl-16 pr-8 text-md text-white placeholder:text-on-surface-variant/50 outline-none shadow-lg italic" placeholder="Buscar beneficiario por DUI o por Nombre." type="text"/>
            </div>
        </div>
        ...
        $(document).ready(function() {
            var table = $('#tablaExonerados').DataTable({
                language: { 
                    ...
                    // Aseguramos que los textos sean "Anterior" y "Siguiente"
                    paginate: {
                        previous: 'Anterior',
                        next: 'Siguiente'
                    }
            ...
            $('#buscadorCustom').on('keyup', function() { table.search(this.value).draw(); });
            ...
            particlesJS("particles-js", {
                "particles": {
                    ...
                    "line_linked": { 
                        "enable": true, "distance": 150, "color": "#31e368", "opacity": 0.15, "width": 1 
                    },
                    "move": { 
